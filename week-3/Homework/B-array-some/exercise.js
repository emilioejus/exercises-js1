...
const evento = element => element === null;
...
var pairs = pairsByIndex.map(function(indexes) {
  ...
  if(pairsByIndex.some(evento)){
    console.error("Error, existe el valor null en el array pairsByIndex")
    return process.exit(pairsByIndex.some(evento));
  }
